...
export interface SelectInputProps {
    ...
    isDisabled?: boolean;
    /** When true, the field auto-flags an error if the user blurs without picking a value. Forwarded to the underlying TextInput. */
    isRequired?: boolean;
    /** Makes the field non-editable — dropdown will not open, chevron is hidden.
     *  Distinct from `isDisabled`: read-only fields are still focusable and the value is copyable. */
    isReadOnly?: boolean;
