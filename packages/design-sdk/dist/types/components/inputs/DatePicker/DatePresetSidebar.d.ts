...
export interface DatePresetSidebarProps extends HTMLAttributes<HTMLDivElement> {
    ...
    /** Optional content pinned to the bottom of the sidebar (e.g. comparison panel). */
    footerSlot?: ReactNode;
}
export declare const DEFAULT_PRESETS: DatePresetOption[];
export declare function DatePresetSidebar({ presets, selectedValue, onPresetSelect, footerSlot, className, ...props }: DatePresetSidebarProps): import("react/jsx-runtime").JSX.Element;
