...
export type DayCellType = 'default' | 'currentDate' | 'rangeStart' | 'rangeIn' | 'rangeEnd' | 'outOfMonth' | 'comparedStart' | 'comparedIn' | 'comparedEnd' | 'intersectStart' | 'intersectIn' | 'intersectEnd';
