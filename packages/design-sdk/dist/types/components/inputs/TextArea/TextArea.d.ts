...
export interface TextAreaProps extends Omit<TextareaHTMLAttributes<HTMLTextAreaElement>, 'onChange' | 'onBlur' | 'onFocus'> {
    ...
    isDisabled?: boolean;
    /** Makes the field non-editable — value is visible and selectable but not changeable.
     *  Distinct from `isDisabled`: read-only fields are still focusable and copyable. */
    isReadOnly?: boolean;
