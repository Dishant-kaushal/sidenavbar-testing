...
export interface BreadcrumbItemProps extends Omit<HTMLAttributes<HTMLLIElement>, 'onClick' | 'children'> {
    /** Text content (alternative to `value` — idiomatic JSX children) */
    children?: ReactNode;
...
export declare function BreadcrumbItem({ type, currentItem, isCurrentPage, showSeparator, size, value, children, icon, href, target, rel, onClick, 'aria-label': ariaLabelProp, accessibilityLabel, className, ...rest }: BreadcrumbItemProps): import("react/jsx-runtime").JSX.Element;
