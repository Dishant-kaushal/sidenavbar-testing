...
import { Rotate as A } from "./Rotate.js";
const f = 0.28, v = [0, 0, 0.2, 1], w = 0.36, u = [0.5, 0, 0, 1], b = 0.36, D = 0.96, I = 0.48, M = [0.3, 0, 0.2, 1], O = () => /* @__PURE__ */ e("svg", { width: "9", height: "9", viewBox: "0 0 9 9", fill: "none", "aria-hidden": !0, children: /* @__PURE__ */ e(
  "path",
  {
...
) }), L = () => /* @__PURE__ */ e("span", { className: "fds-chat-msg__sparkle", children: /* @__PURE__ */ e(A, { animate: !0, children: /* @__PURE__ */ e(O, {}) }) }), T = () => /* @__PURE__ */ e("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", "aria-hidden": !0, children: /* @__PURE__ */ e("polyline", { points: "6 9 12 15 18 9" }) }), k = () => /* @__PURE__ */ e("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", "aria-hidden": !0, children: /* @__PURE__ */ e("polyline", { points: "18 15 12 9 6 15" }) }), x = ({ children: t, isActive: a }) => a ? /* @__PURE__ */ s("span", { className: "fds-chat-msg__shimmer-wrap", children: [
  t,
  /* @__PURE__ */ e(
    o.span,
    {
...
), y = ({ text: t, isLast: a, stepStatus: n }) => /* @__PURE__ */ s("div", { className: "fds-chat-msg__trace-row", children: [
  /* @__PURE__ */ s("div", { className: "fds-chat-msg__trace-timeline", children: [
  ...
  const E = (i) => a === "complete" ? "completed" : r !== void 0 ? i < r ? "completed" : i === r ? "active" : "pending" : i < t.length - 1 ? "completed" : "active", h = (i, c) => c === "completed" && i.completedLabel ? i.completedLabel : i.label;
  return /* @__PURE__ */ s("div", { className: "fds-chat-msg__reasoning", children: [
    a === "complete" && /* @__PURE__ */ s(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ e(
      o.div,
      {
        ...
        children: /* @__PURE__ */ e("div", { className: "fds-chat-msg__reasoning-inner", children: p || !C ? t.map((i, c) => {
          const l = E(c);
          return /* @__PURE__ */ e(y, { text: h(i, l), isLast: c === t.length - 1, stepStatus: l }, i.label);
        }) : /* @__PURE__ */ s(N, { children: [
          t.slice(0, -1).map((i, c) => {
            const l = c === t.length - 2;
            return /* @__PURE__ */ e(
              o.div,
              {
          ...
          t.length > 0 && /* @__PURE__ */ e(
            o.div,
            {
              ...
              animate: { opacity: 1, y: 0 },
              transition: { duration: f, ease: v },
              children: /* @__PURE__ */ s("div", { className: "fds-chat-msg__trace-row", children: [
